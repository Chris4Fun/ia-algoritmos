...
def run(salesmanCapacity, cities, temperature, minTemperature, coolingRate, maxIterations):
  ...
  sa = TSMSimulatedAnnealing(temperature_i=temperature, minTemperature_i=minTemperature,
                          coolingRate_i=coolingRate, maxIterations_i=maxIterations, salesmanCapacity_i=salesmanCapacity,
                          cities_i=cities)
  sa.begin()
  pass